...
function c(){
this.aInfoMap={},this.iframes=window.withoutIframe?document.getElementsByClassName("video_iframe rich_pages"):document.getElementsByTagName("iframe");
}
function u(e,t){
...
function e(t){
t=t||{};
for(var e=document.getElementsByClassName("video_iframe rich_pages"),i=[],o=0,r=e.length;r>o;o++){
