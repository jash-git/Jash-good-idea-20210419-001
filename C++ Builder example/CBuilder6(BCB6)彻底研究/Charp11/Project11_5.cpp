...
USEFORM("Test115ServerImpl.cpp", Test115Server); /* TCRemoteDataModule: File Type */ /* Test115Server: CoClass */
USEFORM("Unit11_5.cpp", Form1);
//---------------------------------------------------------------------------
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_Test115Server, TTest115ServerImpl)
END_OBJECT_MAP()
//---------------------------------------------------------------------------
