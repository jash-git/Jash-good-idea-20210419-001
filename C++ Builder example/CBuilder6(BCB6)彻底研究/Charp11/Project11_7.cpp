...
USEFORM("Unit11_7.cpp", Form1);
USEFORM("Test117ServerImpl.cpp", Test117Server); /* TCRemoteDataModule: File Type */ /* Test117Server: CoClass */
//---------------------------------------------------------------------------
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_Test117Server, TTest117ServerImpl)
END_OBJECT_MAP()
//---------------------------------------------------------------------------
