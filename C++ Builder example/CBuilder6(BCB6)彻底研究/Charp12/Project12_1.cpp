...
USEFORM("Unit12_1.cpp", Form1);
USEFORM("Test121ServerImpl.cpp", Test121Server); /* TCRemoteDataModule: File Type */ /* Test121Server: CoClass */
//---------------------------------------------------------------------------
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_Test121Server, TTest121ServerImpl)
END_OBJECT_MAP()
//---------------------------------------------------------------------------
