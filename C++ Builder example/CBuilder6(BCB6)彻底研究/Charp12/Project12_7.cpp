...
USEFORM("Test127ServerImpl.cpp", Test127Server); /* TCRemoteDataModule: File Type */ /* Test127Server: CoClass */
USEFORM("Unit12_7.cpp", Form1);
//---------------------------------------------------------------------------
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_Test127Server, TTest127ServerImpl)
END_OBJECT_MAP()
//---------------------------------------------------------------------------
