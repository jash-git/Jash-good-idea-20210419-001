...
USEFORM("Unit16_1.cpp", Form1);
USEFORM("InterExpressSerImpl.cpp", InterExpressSer); /* TCRemoteDataModule: File Type */ /* InterExpressSer: CoClass */
//---------------------------------------------------------------------------
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_InterExpressSer, TInterExpressSerImpl)
END_OBJECT_MAP()
//---------------------------------------------------------------------------
