...
USEFORM("ActiveFormX2Impl1.cpp", ActiveFormX2); /* TActiveForm: File Type */ /* ActiveFormX2: CoClass */
//---------------------------------------------------------------------------
#pragma package(smart_init)
TComModule  ActiveFormX2Proj1Module;
TComModule &_Module = ActiveFormX2Proj1Module;
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_ActiveFormX2, TActiveFormX2Impl)
END_OBJECT_MAP()
