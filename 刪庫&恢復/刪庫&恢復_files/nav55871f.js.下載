...
var i=n("biz_wap/jsapi/core.js"),o=n("common/navShadow.js"),e=n("biz_wap/utils/mmversion.js"),t=e.isAndroid,a=function(n){
!n.noNavShadowWhenUseWeui&&o.show(),window.weui.actionSheet(n.buttons,[{
label:"取消",
onClick:function(){
...
onClose:function(){
!n.noNavShadowWhenUseWeui&&o.hide();
}
});
};
return{
show:function(n){
if(!t)return void a(n);
var o={};
...
/:ok$/.test(i.err_msg)?"function"==typeof o[i.id]&&o[i.id]():/:canceled$/.test(i.err_msg)?"function"==typeof n.cancel&&n.cancel():"action isn't supported"===i.err_desc||"action not support"===i.err_desc?a(n):"function"==typeof n.fail&&n.fail(i.err_msg);
});
}
};
...
define("appmsg/emotion/emotion_panel.js",["widget/wx-widget/wx_emotion_panel.css","biz_wap/jsapi/core.js","biz_common/dom/event.js","biz_common/utils/emoji_panel_data.js","biz_common/utils/emoji_data.js","biz_wap/utils/mmversion.js"],function(require,exports,module,alert){
"use strict";
require("widget/wx-widget/wx_emotion_panel.css");
var JSAPI=require("biz_wap/jsapi/core.js"),DomEvent=require("biz_common/dom/event.js"),panelData=require("biz_common/utils/emoji_panel_data.js"),emojiData=require("biz_common/utils/emoji_data.js"),mmversion=require("biz_wap/utils/mmversion.js"),emotionPanelList=[],EmotionPanel=function(){
function EmotionPanel(e){
_classCallCheck(this,EmotionPanel),this.isShow=!1,this.opt=e,this.limit=e.limit,
mmversion.isAndroid&&this.__initEmojiPanel(),emotionPanelList.push(this);
}
...
key:"__getContent",
value:function(e,t){
return this.opt.input.value.substring(e,t);
}
},{
key:"__setInputValue",
value:function(e,t){
...
}else i.value=e,this.__setSelectionRange(t);
}
},{
key:"__setSelectionRange",
value:function(e){
var t=this.opt.input;
t.setSelectionRange(e,e),t.blur();
}
},{
key:"__insertContent",
value:function(e){
if(this.opt.input){
var t=this.opt.input,n=this.__getContent(0,t.selectionStart),i=this.__getContent(t.selectionEnd),o=n+e+i,a=this.opt.counter?this.opt.counter(o):o.length;
if(0!==this.limit&&a>this.limit)return;
this.__setInputValue(EmotionPanel.__filterContent(o),t.selectionStart+e.length);
}
}
},{
key:"__delContent",
value:function(){
if(this.opt.input){
var e=this.opt.input,t=this.__getContent(0,e.selectionStart),n=this.__getContent(e.selectionEnd),i=void 0,o=void 0;
if(e.selectionStart===e.selectionEnd){
for(var a=0;a<emojiData.length;a++){
var s=emojiData[a];
if(s.cn&&t.endsWith(s.cn)){
i=t.substring(0,t.length-s.cn.length)+n,o=e.selectionStart-s.cn.length;
break;
}
if(s.hk&&t.endsWith(s.hk)){
i=t.substring(0,t.length-s.hk.length)+n,o=e.selectionStart-s.hk.length;
break;
}
if(s.us&&t.endsWith(s.us)){
i=t.substring(0,t.length-s.us.length)+n,o=e.selectionStart-s.us.length;
break;
}
if(s.emoji&&t.endsWith(s.emoji)){
i=t.substring(0,t.length-s.emoji.length)+n,o=e.selectionStart-s.emoji.length;
break;
}
}
"string"!=typeof i&&(i=t.substring(0,t.length-1)+n,o=e.selectionStart-1);
}else i=t+n,o=e.selectionStart;
this.__setInputValue(EmotionPanel.__filterContent(i),o);
}
}
},{
...
i.appendChild(o),e.panel.appendChild(i);
...
(.5>i&&n>m||.5>o-i-a&&m>n)&&t.preventDefault();
}),DomEvent.tap(this.panel,function(t){
if("comment_primary_emotion"===t.target.className){
