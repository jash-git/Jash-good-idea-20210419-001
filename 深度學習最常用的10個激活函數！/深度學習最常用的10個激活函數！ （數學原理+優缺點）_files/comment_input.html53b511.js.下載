...
define("pages_new/common_share/video/lifecycle_manager.js",["biz_wap/jsapi/log.js","biz_wap/utils/ajax.js","common/utils.js","biz_wap/jsapi/core.js","pages_new/modules/utils/url.js","pages/video_collection/report.js"],function(e){
"use strict";
function n(e){
...
window.appmsg_token=e&&e.base_resp&&e.base_resp.base_resp&&e.base_resp.base_resp.appmsg_token||window.appmsg_token||"",
window.__initGlobalData(e,n),window.__initCgiDataConfig(e,n),window.__initCommentConfig(e,n);
}
function s(e){
a(e.init),n(e.destroy),o(e.getData),"function"==typeof e.init&&e.init(!0);
}
function f(e,n){
_&&n&&!P[n]&&u({
type:"GET",
...
timeout:2e3,
success:function(a){
console.info("[Lifecycle Manager] Preload PageData",n,e),g.info("[Lifecycle Manager] Preload PageData",n,e);
try{
P[n]=JSON.parse(a);
}catch(o){
console.error("[Lifecycle Manager] Parse Preload PageData Failed",n,e,o),g.info("[Lifecycle Manager] Parse Preload PageData Failed",n,e,o.toString());
}
P[n]&&P[n].video_page_info&&"string"==typeof P[n].video_page_info.cover_url&&((new Image).src=P[n].video_page_info.cover_url);
}
});
}
function l(e,n){
if(!v){
if(v=!0,console.info("[Lifecycle Manager] Start to switch to",e),g.info("[Lifecycle Manager] Start to switch to",e),
y.leaveReportNowForSwitchVideo(),!_)return void p.loadNewPageKeepingHistoryStackIfSecOpen(e);
var a=_extends({},w.getParams(location.href),w.getParams(e)),o=3e3,s=2,f=0,l=null;
i();
var h=function(){
if(f===s)if(l&&l.base_resp&&0===l.base_resp.ret){
P={};
var n=w.getParams(location.href);
r(l,n),t(),v=!1,console.info("[Lifecycle Manager] Finish to switch to",e),g.info("[Lifecycle Manager] Finish to switch to",e);
}else p.loadNewPageKeepingHistoryStackIfSecOpen(e);
},m=setTimeout(function(){
location.href===e?location.reload():p.loadNewPageKeepingHistoryStackIfSecOpen(e);
},o),S=function k(e){
document.removeEventListener("WeixinJSBridgeAuthChanged",k),console.info("[Lifecycle Manager] GetA8Key Success",e.state),
g.info("[Lifecycle Manager] GetA8Key Success",e.state),history.replaceState(null,"",e.fullUrl),
clearTimeout(m),f++,h();
};
document.addEventListener("WeixinJSBridgeAuthChanged",S),history.replaceState(null,"",e);
var L=function j(){
document.removeEventListener("WeixinJSBridgeSpaHistoryChanged",j),console.info("[Lifecycle Manager] History Stack Changed"),
g.info("[Lifecycle Manager] History Stack Changed"),delete window.__second_open__,
...
g.info("[Lifecycle Manager] Invoke GetA8Key Success",JSON.stringify(e)));
});
};
document.addEventListener("WeixinJSBridgeSpaHistoryChanged",L),n&&P[n]?(console.info("[Lifecycle Manager] Get Cache PageData",n),
g.info("[Lifecycle Manager] Get Cache PageData",n),l=P[n],r(l,a),c(l),f++,h()):u({
type:"GET",
url:e,
async:!1,
timeout:2e3,
success:function(n){
console.info("[Lifecycle Manager] Get PageData"),g.info("[Lifecycle Manager] Get PageData");
try{
l=JSON.parse(n);
}catch(o){
console.error("[Lifecycle Manager] Parse PageData Failed",e,o),g.info("[Lifecycle Manager] Parse PageData Failed",e,o.toString());
}
l&&(r(l,a),c(l)),f++,h();
},
error:function(){
p.loadNewPageKeepingHistoryStackIfSecOpen(e);
}
});
}
}
var g=e("biz_wap/jsapi/log.js"),u=e("biz_wap/utils/ajax.js"),p=e("common/utils.js"),d=e("biz_wap/jsapi/core.js"),w=e("pages_new/modules/utils/url.js"),y=e("pages/video_collection/report.js"),_=!1,h=[],m=[],S=[],v=!1,P={};
return{
register:s,
openNewVideoPage:l,
