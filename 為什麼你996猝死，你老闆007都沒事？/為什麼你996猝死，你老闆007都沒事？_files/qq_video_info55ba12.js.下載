...
I.invoke("getNetworkType",{},function(t){
...
onReady:function(){},
onUserplay:function(){}
},this.cgiData=_extends({},window.cgiData,t),w(this._o,e),(!Q.isWechat||!Q.isIOS&&!Q.isAndroid||Q.isIOS&&D.ltVersion("7.0.9",!1)||Q.isAndroid&&D.ltVersion("7.0.10",!1)||!this._o.videoMd5)&&(this._o.jsapiFullScreen=!1,
...
case 20003:
Q.isWechat&&Q.isAndroid&&D.gtVersion("7.0.16",1)&&(i["1080p"]={
index:o
});
break;
...
function n(e){
window.networkType||Q.networkType||Q.isPc?e():Y?I.invoke("getNetworkType",{},function(t){
...
for(var e=k.document.getElementsByClassName("video_iframe rich_pages"),t=0;t<e.length;t++)if(n._o.vid===e[t].getAttribute("vid")&&e[t].adVidFromAppmsg)return!0;
...
mid:t.mid,
idx:t.idx,
auto:!(!Q.isAndroid||!D.gtVersion("7.0.16",1)),
onSuccess:function(t){
...
(1*t.format_id!==20003||Q.isWechat&&Q.isAndroid&&D.gtVersion("7.0.16",1))&&g.push({
...
if(Q.isWechat&&Q.isAndroid&&D.gtVersion("7.0.16",1)){
var r={
10004:1,
10003:2,
10002:3,
...
var Y=-1!=navigator.userAgent.indexOf("MicroMessenger")&&(D.isIOS||D.isAndroid||D.isWp);
return{
getHashByVid:c,
mpVideoPlayer:o,
