...
w.initLikeShareDom({
shareShow:t.share_flag&&!!t.share_flag.show&&!z.isInMiniProgram,
...
var I=document.getElementById("js_cmt_container");
if(1==t.comment_entrance_enable_for_preview&&window.is_temp_url&&I&&(I.style.display="block"),
...
})),t.comment_enabled&&I&&(I.style.display="block"),z.isIOS&&"block"===I.style.display&&location.href.match(/fontScale=\d+/)&&x.isIPadOS13){
var S=location.href.match(/fontScale=(\d+)/);
x.setFontSize(I,parseFloat(S[1])/100);
}
...
e("appmsg/log.js")),b=(e("rt/appmsg/getappmsgext.rt.js"),e("a/a_utils.js")),k=e("appmsg/related_article.js"),j=[],x=e("appmsg/set_font_size.js"),z=(e("biz_wap/utils/device.js"),
